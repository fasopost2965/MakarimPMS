...
Voir `ECARTS_ASSUMES.md` §Candidats pour la liste des arbitrages produit encore ouverts (city ledger, multi-folio vs folio unique, numérotation de facture, matérialisation des pénalités — le périmètre de l'avoir et le chiffrement PII sont désormais tranchés, voir RD-005 et RD-006). Ces questions ne sont **pas** tranchées ici — ce registre attend leur décision effective pour les consigner.
