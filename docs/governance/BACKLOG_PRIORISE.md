...
7. **CH-010** — Déduplication client *(arbitrage tranché — RD-011 — implémentation prête à démarrer)*
...
| ~~CH-010~~ | ✅ Tranché — approche hybride (contrainte dure sur `pieceIdentite`, détection souple sur email/téléphone), voir `REGISTRE_DECISIONS.md` (RD-011). Conflit technique avec le chiffrement CH-004 détecté et résolu (index aveugle `pieceIdentiteHash`) avant tout code — implémentation à suivre. |
