...
- **À implémenter** : ~~CH-001~~ (terminé), ~~CH-002~~ (terminé), ~~CH-004~~ (terminé), CH-005, CH-006, CH-010, CH-011 (backend), CH-013 (partiel — `ANNULEE_PAR_AVOIR` résolu par CH-001, `StatutSejour.ANNULE` restant), CH-014, CH-024, CH-025 — aucun arbitrage de fond ne remet en cause leur nécessité, seul le « comment » reste à trancher pour certains.
