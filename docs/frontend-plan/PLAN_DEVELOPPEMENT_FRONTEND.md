...
Détail chantier par chantier (source, criticité, impacts, dépendances, critères de validation, effort estimé) : `docs/governance/REGISTRE_CHANTIERS.md`, section « Chantiers frontend — issus de l'audit qualité (Phase 11) ». Ordre d'exécution avec justification par chantier : `docs/governance/BACKLOG_PRIORISE.md`, Vague 4.
